// this was how we interfaced with MIDI and Timer services
// I think this is still required by MobiusContext, though work toward
// removing any dependencies on this
// This will be implemented by JuceMidiInterface which be mostly stubs
