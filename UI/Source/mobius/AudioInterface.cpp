 ...
 * pairs of channels.  Need more flexibility.
 */
void AbstractAudioStream::setOutputChannels(int channels)
{
 ...
 */
int AbstractAudioStream::calcLatency(double ltime)
{
    return (int)((double)mSampleRate * ltime);
}

int AbstractAudioStream::getInputLatencyFrames()
{
...
int AbstractAudioStream::getOutputLatencyFrames()
{
