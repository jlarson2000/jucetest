 ...
 *
 */
BindingResolver::BindingResolver(Mobius* mob)
{
...
Action** BindingResolver::allocBindingArray(int size)
{
...
void BindingResolver::freeBindingArray(Action** array, int size)
{
	if (array != NULL) {
 ...
 */
void BindingResolver::assimilate(Mobius* mobius,
                                         OldBindingConfig* bindings)
{
	if (bindings != NULL) {
 ...
 */
bool BindingResolver::isSpreadable(Action* a)
{
    int status = a->getMidiStatus();
 ...
 */
int BindingResolver::getSpreadRange(Action* a)
{
 ...
 *
 */
void BindingResolver::addBinding(Action** array, 
                                            int max, int index,
                                            Action* neu)
{
 ...
 * more Actions.
 */
void BindingResolver::doMidiEvent(Mobius* mobius, MidiEvent* e)
{
	Action* actions = NULL;
