...
MidiConfig* MobiusConfig::getMidiConfigs()
{
	return mMidiConfigs;
}

const char* MobiusConfig::getSelectedMidiConfig()
{
    return mSelectedMidiConfig;
}

void MobiusConfig::clearMidiConfigs()
{
    delete mMidiConfigs;
...
void MobiusConfig::addMidiConfig(MidiConfig* c) 
{
	// keep them ordered
	MidiConfig *prev;
...
void MobiusConfig::setSelectedMidiConfig(const char* s)
{
    delete mSelectedMidiConfig;
...
MidiBinding::MidiBinding(XmlElement* e)
{
	init();
	parseXml(e);
}

void MidiBinding::init()
{
	mNext = NULL;
	mName = NULL;
...
void MidiBinding::setNext(MidiBinding* c)
{
	mNext = c;
}

MidiBinding* MidiBinding::getNext()
{
	return mNext;
}


void MidiBinding::setType(BindingType type) 
{
	mType = type;
}

BindingType MidiBinding::getType()
{
	return mType;
}

void MidiBinding::setName(const char *name) 
{
	delete mName;
	mName = CopyString(name);
}

const char* MidiBinding::getName()
{
	return mName;
}

void MidiBinding::setTrack(int t) 
{
	mTrack = t;
}

int MidiBinding::getTrack()
{
	return mTrack;
}

void MidiBinding::setGroup(int t) 
{
	mGroup = t;
}

int MidiBinding::getGroup()
{
	return mGroup;
}
...
void MidiBinding::getMidiString(char* buffer, bool includeChannel)
{
...
MidiConfig::MidiConfig(XmlElement* e)
{
	init();
	parseXml(e);
}
...
Target* MidiConfig::getTarget()
{
	return TargetBindings;
}

void MidiConfig::setNext(MidiConfig* c)
{
	mNext = c;
}

MidiConfig* MidiConfig::getNext()
{
	return mNext;
}

Bindable* MidiConfig::getNextBindable()
{
	return mNext;
}

void MidiConfig::setTrackGroups(int g)
{
	if (g >= 0 && g <= MAX_TRACK_GROUPS)
	  mTrackGroups = g;
}

int MidiConfig::getTrackGroups()
{
	return mTrackGroups;
}

MidiBinding* MidiConfig::getBindings()
{
	return mBindings;
}

void MidiConfig::addBinding(MidiBinding* p) 
{
...
void MidiConfig::removeBinding(MidiBinding* c)
{
}
 ...
 */
BindingConfig* MidiConfig::upgrade()
{
