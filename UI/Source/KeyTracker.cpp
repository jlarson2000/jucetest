...
{
    Instance.addLocalListener(l);
}

void KeyTracker::removeListener(Listener* l)
{
    Instance.removeLocalListener(l);
}
...
void KeyTracker::addLocalListener(Listener* l)
{
    if (!listeners.contains(l))
      listeners.add(l);
}

void KeyTracker::removeLocalListener(Listener* l)
{
